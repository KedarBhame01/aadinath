"""
Django settings for aadinath project.
...
SECRET_KEY = 'django-insecure-r$5qsw+x**@i_0w#3egq27tqbvwoqqi8^!2wiw=hihs+nq97t#'
...
WSGI_APPLICATION = 'aadinath.wsgi.application'
