...
def payment_page(request):
    context = {
        'amount': request.GET.get('amount', 100),  # Default amount
        'purpose': request.GET.get('purpose', 'Payment'),
        'description': request.GET.get('description', 'Payment for services'),
        'company_name': 'Your Company Name',
        'company_logo': '/static/images/logo.png',  # Update with your logo path
    }
